"""shopify_sendbox URL Configuration
...
urlpatterns = [
    ...
    path('doc/', schema_view.with_ui('redoc', cache_timeout=0), name='schema_redoc'),
    re_path(r'^doc(?P<format>\.json|\.yaml)$', schema_view.without_ui(cache_timeout=0), name='schema_json'),
]
